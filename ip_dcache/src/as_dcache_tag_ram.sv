// as_dcache_tag_ram.sv  –  D-Cache tag store — behavioral model (FPGA / simulation)
//
// ASIC target: replace with WAYS parallel X-Fab SRAM macros, each SETS entries × TAG_BITS wide.
// Same interface and pin mapping as as_icache_tag_ram.sv.
`timescale 1ns/1ps

module as_dcache_tag_ram #(
